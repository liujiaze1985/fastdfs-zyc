...
public class Storage {
  ...
  public Storage(String id, String curStatus, String ipAddr, String srcIpAddr, String domainName, String version,
      long totalMB, long freeMB, int uploadPriority, Date joinTime, Date upTime, int storePathCount,
      int subdirCountPerPath, int storagePort, int storageHttpPort, int currentWritePath, long totalUploadCount,
      long successUploadCount, long totalAppendCount, long successAppendCount, long totalModifyCount,
      long successModifyCount, long totalTruncateCount, long successTruncateCount, long totalSetMetaCount,
      long successSetMetaCount, long totalDeleteCount, long successDeleteCount, long totalDownloadCount,
      long successDownloadCount, long totalGetMetaCount, long successGetMetaCount, long totalCreateLinkCount,
      long successCreateLinkCount, long totalDeleteLinkCount, long successDeleteLinkCount, long totalUploadBytes,
      long successUploadBytes, long totalAppendBytes, long successAppendBytes, long totalModifyBytes,
      long successModifyBytes, long totalDownloadloadBytes, long successDownloadloadBytes, long totalSyncInBytes,
      long successSyncInBytes, long totalSyncOutBytes, long successSyncOutBytes, long totalFileOpenCount,
      long successFileOpenCount, long totalFileReadCount, long successFileReadCount, long totalFileWriteCount,
      long successFileWriteCount, Date lastSourceUpdate, Date lastSyncUpdate, Date lastSyncedTimestamp,
      Date lastHeartBeatTime, boolean ifTrunkServer, String cpu, float mem, Group group, Date created) {
    super();
    this.id = id;
